            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (verticalOffset == 0) {
                    if (state != CollapsingToolbarLayoutState.EXPANDED) {
                        ...
                        StatusBarUtil.StatusBarDarkMode(SuspendActivity.this, 3);
                        StatusBarUtil.transparencyBar(SuspendActivity.this);
                    }
                } else if (Math.abs(verticalOffset) >= appBarLayout.getTotalScrollRange()) {
                    if (state != CollapsingToolbarLayoutState.COLLAPSED) {
                        StatusBarUtil.StatusBarLightMode(SuspendActivity.this);
                        collapsingToolbarLayout.setTitle("Tinker Title");//设置title不显示
